...
(function () {
  ...
  const THEMES = {
    default: {
      ...
      dark: {
        ...
        "color-accent": "#fb923c", "color-accent-hover": "#fdba74", "color-accent-soft": "#7c2d12",
        "color-link": "#fafafa", "color-link-hover": "#fb923c",
        "color-success": "#4ade80", "color-success-soft": "#14532d",
        "color-warning": "#fbbf24", "color-warning-soft": "#78350f",
    ...
    newspaper: {
      light: {
        ...
        "color-warning": "#92400e", "color-warning-soft": "#fef3c7",
      ...
      dark: {
        ...
        "color-accent": "#d4a373", "color-accent-hover": "#e2bd90", "color-accent-soft": "#3a2f1c",
        "color-link": "#f4ecd8", "color-link-hover": "#d4a373",
    ...
    editorial: {
      light: {
        ...
        "color-warning": "#a16207", "color-warning-soft": "#fefce8",
  ...
  const PRE_PAINT_FALLBACK_BG = "#faf9f7";

...
export const en: Translations = {
  ...
  users: {
    ...
    summary_one: "{{count}} user across the workspace — admins, editors, authors, and viewers.",
    summary_other: "{{count}} users across the workspace — admins, editors, authors, and viewers.",
    columns: {
      user: "User",
      role: "Role",
      status: "Status",
  ...
  settings: {
    ...
    gallery: "Gallery",
    resetHint:
      "Need a clean slate? Reset removes your saved theme and reverts to default in auto mode.",
    ...
    persistedHint:
      "Settings are read from and persisted to /api/v1/settings.",
  },
